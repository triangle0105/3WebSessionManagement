...
namespace _23DesginMode._32Modes
{
    ...
    class Client66
    {
        ...
        {
            // 现在客户端可以通过电适配要使用2个孔的插头了
            ThreeHole6 threehole = new PowerAdapterob6();
            threehole.Request();
            Console.ReadLine();
        }
    }
    ...
    /// </summary>
    public class PowerAdapterob6 : ThreeHole6
    {
        // 引用两个孔插头的实例,从而将客户端与TwoHole联系起来
        public TwoHole6 twoholeAdaptee = new TwoHole6();
